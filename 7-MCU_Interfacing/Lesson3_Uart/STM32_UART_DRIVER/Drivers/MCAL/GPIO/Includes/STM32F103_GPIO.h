...
#define GPIO_MODE_INPUT_FLOATING 		((uint8_t)0x01) //1: Floating input (reset state)
...
#define GPIO_MODE_OUTPUT_OD				((uint8_t)0x05)s //5: General purpose output Open-drain
